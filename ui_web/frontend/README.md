...
12. 已有缓存的情况下首次打开“书库”页，确认页面顶部出现“当前显示缓存，未校验磁盘”提示后，再确认刷新按钮不会自动进入 loading 态
13. 在“书库”页执行筛选、刷新以及作品卡片上的“更新”按钮，确认没有前端报错
14. 通过“智能更新”入口触发更新，命中候选项时确认页面会展示进度反馈且不会整页卡死
15. 通过“全量更新”入口触发更新时，确认页面会展示进度反馈且不会整页卡死
16. 智能更新返回空结果时，确认只出现提醒文案且没有任何 `POST /api/downloads` 请求，下载队列里也没有新增项
17. 在“下载队列”页点击“停止全部”，确认按钮立即进入提交态，并看到停止摘要文案
18. 如果触发了停止全部，确认后续任务状态会继续刷新，不会停留在无反馈状态
